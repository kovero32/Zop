...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if not public_token:
            await msg.edit_text("❌ Token alınamadı")
            log_kullanici(user, numara, "Token Alınamadı")
        ...
        await msg.edit_text("🔥 3 concurrent istek atılıyor (satın alma)...")
        ...
        await msg.edit_text("⚠️ İşlem tamamlandı (hata)")
